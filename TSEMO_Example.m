...
% Matlab Home, Set Path, Add folder with subfolders, select "TSEMO_V1"
% folder
...
opt = TSEMO_options;             % call options for solver, see TSEMO_V1_opt file to adjust
...
legend('Initial LHC','Algorithm','Pareto front','Location','Northeast')
